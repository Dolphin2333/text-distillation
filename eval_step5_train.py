...
def load_val_data(data_root, emb_file, label_file):
    """
    ...
    """
    emb_path = os.path.join(data_root, emb_file)
...
def main():
    ...
    x_val, y_val = load_val_data(args.data_root, args.val_emb_file, args.val_label_file)
