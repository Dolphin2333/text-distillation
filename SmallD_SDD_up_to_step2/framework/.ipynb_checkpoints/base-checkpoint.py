...
# EDITED PART    # EDITED PART    # EDITED PART    # EDITED PART    # EDITED PART    # EDITED PART    # EDITED PART    
    ...
    if args.ddtype == 'standard':
        fname = './out_IPC_'+str(args.num_per_class)+'_no_cu_'+str(args.window)+args.fname+'.h5'
    else:
        fname = './save/{}/IPC_{}_{}_cu_{}_{}_{}_{}.h5'.format(str(args.dataset), str(args.num_per_class),
